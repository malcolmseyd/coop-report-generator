...
\begin{center}
  ...
  {{CompanyName}} \\
  {{address.city}}, {{address.province}}, {{address.country}} \\      % companies office location
  \vspace{1cm}

  {{user.firstname}} {{user.lastname}} \\
  {{studentNumber}} \\
  Work Term {{termNumber}} \\                % work term ex. 001, 002, 003, 004, etc...
  Computer Science \\
  {{user.email}} \\
  {{date.month}} {{date.day}}, {{date.year}} \\              % due date for work term report
  \vspace{1cm}
